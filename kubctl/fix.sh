...
kubectl -n mvd set env deploy/ita-dataplane \
  EDC_DATAPLANE_API_PUBLIC_BASEURL="https://test.ctag-edmus.com/ita-dp/api/public"
kubectl -n mvd set env deploy/avanza-dataplane \
  EDC_DATAPLANE_API_PUBLIC_BASEURL="https://test.ctag-edmus.com/avanza-dp/api/public"
kubectl -n mvd set env deploy/ctag-dataplane \
  EDC_DATAPLANE_API_PUBLIC_BASEURL="https://test.ctag-edmus.com/ctag-dp/api/public"
